...
- **Home rows you choose**: up to 12 rows, each set to one of more than 70 row types and put in any order (see [Home rows](#home-rows)), including **Top 10** rows with big rank numbers, **Because You Watched**, **Coming Soon**, **New This Week**, **Directed By …**, **Marvel in Story Order**, the **Family List**, mood rows like *Feel-Good Movies* and *Short on Time*, and rows from **any add-on's folder**. Hold OK on a row's card to **move or hide the row**. With Live TV there are also **My Channels** (the channels you pick), **On now** and two rows of a **channel group** you choose (Sports, News). **Continue Watching: On Demand** has what you're part-way through from an IPTV catalogue, and **Continue Anywhere** everything you're part-way through, wherever it is (the library and the MediaHub add-ons), with **Worth a Rewatch** for the ones you loved long ago. After time away, a **New since you were last here** banner lists what was added. By default they are Continue Watching, Up Next, My List, Recommended For You, New Movies, New Episodes, TV Shows For You, Collections and Top Rated Movies. A row is hidden when it has nothing in it.
...
- **Playback**: a player bar in your accent colour. On the left is the title's **clearart** (the picture with the characters and logo), or its logo, or the poster. Next to it: *Now playing*, the title, **badges** for the picture and sound (4K, HDR10 / Dolby Vision, Dolby Digital / Atmos / DTS, 5.1) and the audio and subtitle language, the progress bar you can scrub, and round buttons. There's also a seek bar, bookmarks, a subtitle download screen that works with any subtitle add-on (OpenSubtitles, Subdl and others from Kodi's repository), and:
  ...
  - **Reactions**: tap an emoji on your phone (MediaHub Web Remote) and it floats up over the picture with your name, and in the other room too when you watch together;
  - **Previously on**: come back to a show after two weeks and a card reminds you where you were before the episode carries on;
  - **Pause when everyone leaves the room**, with a Home Assistant presence or motion sensor;
...
- **Spoiler-free**: an episode you haven't watched shows the show's picture, *Episode 4* and no story until you've seen it (**Skin settings → Spoiler-free**).
...
- **More MediaHub add-ons** (also in the MediaHub repository, each on its own): **MediaHub Radio** (thousands of internet radio stations), **MediaHub Podcasts** (find, follow and listen), **MediaHub Web Remote** (your phone's web browser as the remote, a second screen, and Listen on this phone), **MediaHub Sync** (what you've watched and your lists, the same on every Kodi in the house, and Watch together in two rooms), **MediaHub Cinema**, **MediaHub Import**, **MediaHub Audiobooks**, **MediaHub Classics**, **MediaHub Weather**, **MediaHub Scores** (your teams' fixtures and results), **MediaHub News** (headlines, bulletins and a news ticker), **MediaHub Space** (NASA's picture of the day), **MediaHub Recipes** (something to cook tonight, with Cook along), **MediaHub Concerts** (live shows from the Live Music Archive) and **MediaHub Relax** (rain, waves, a fire and calm noise, with a sleep timer). See [More MediaHub add-ons](#more-mediahub-add-ons).
...
- **Profiles**: a "Who's watching?" screen at start-up where every profile has a colourful **avatar** (pick your own in Skin settings), a **birthday** (a happy birthday greeting, confetti and Birthday picks on the day), and a Profiles settings page. Each Kodi profile has its own watched progress, My List and settings (see [Profiles](#profiles)).
...
- **Kids mode**: only family-rated titles everywhere, protected by a PIN, with a **bedtime** that locks the screen until morning and a daily **screen time**, and **Ask a grown-up**, answered on a grown-up's phone (see [Kids mode](#kids-mode)).
...
- **Continue Anywhere**: everything you're part-way through, newest first, wherever it is: films and episodes in the library, On demand, MediaHub IPTV, Classics, Audiobooks, Podcasts and Concerts.
- **Worth a Rewatch**: films and shows you gave a thumbs up (or loved) and haven't watched for over a year, the best loved and longest ago first.
- With [MediaHub Concerts](#mediahub-concerts): **Concerts: Continue Listening**.
...
- **Greeting**: *Good morning*, *Good afternoon*, *Good evening* or *Up late*, with your avatar, above the banner. On your [birthday](#profiles) it says *Happy birthday*. **Skin settings → Say good morning / evening on the home screen** turns it off.
...
**Birthdays**: **Skin settings → Your birthday** keeps a day and month for this profile (each profile has its own). On the day, the home greeting says *Happy birthday, Alex!*, confetti falls down the home screen the first time it opens, and a **Birthday picks** row above the network cards has that profile's favourites: what they loved or gave a thumbs up, their My List, and what they've watched most. (A 29 February birthday comes on the 28th in other years.)
...
**Ask a grown-up**: with [MediaHub Web Remote](#mediahub-web-remote) on, the bedtime and screen-time screens also have **Ask a grown-up**. The question pops up on every phone with the Remote page open (*The kids are asking: for a bit more TV today*), with **+15 min**, **+30 min**, **+1 hour**, **No limit today** or **Yes, until the morning**, and **Not now**. The first answer from a phone asks for the Kids mode PIN, once; after that the phone is trusted. The TV says who answered and what.
...
- **Reactions**: tap 😂 😮 ❤️ 👏 😱 👍 🍿 or 😢 under what's playing on the [Web Remote](#mediahub-web-remote) and it floats up over the picture for a few seconds with your name (the one you typed for games). While you watch together, the other room sees them too.
- **Previously on**: start an episode of a show you haven't watched for two weeks or more (and whose previous episode you've seen) and, before it plays, a card shows the previous episode's picture, title and story, and carries on by itself after 20 seconds. **Play** starts now and **Stop** stops. It doesn't come up when you resume part-way through. **Skin settings → "Previously on" when you come back to a show after two weeks** turns it off.
- **Spoiler-free**: **Skin settings → Spoiler-free** hides the title, picture and story of every episode you haven't watched (in the rows, the season lists, the details page and the Up next card): you see the show's picture and *Episode 4* until you've seen it.
- **Pause when everyone leaves the room**: in **Skin settings → Cinema mode (Home Assistant)**, name a presence or motion sensor (`binary_sensor.living_room_occupancy`, `input_boolean.someone_home` or a person) and turn on **Pause when everyone leaves the room**. When it has said *nobody* for 30 seconds, the video pauses (*Paused: nobody's in the room*), and it plays on by itself when someone comes back, if it was the one that paused it.
...
**Reactions**: a row of emoji under what's playing; tap one and it floats up over the picture on the TV with your name. (A few taps a second at most per phone.)

**Ask a grown-up**: when the kids ask from the bedtime or screen-time screen, the question appears at the top of the Remote page with its answers (see [Kids mode](#kids-mode)).

**My List, watched and thumbs**: hold a poster in Search or Browse (or right-click it) and the sheet adds **Add to My List** / **On My List**, **Mark as watched** / **unwatched** (a show: all its episodes), **Thumbs up** and **Thumbs down**, as well as the play buttons.
...
**MediaHub Recipes** (`plugin.video.mediahub.recipes`) has hundreds of recipes from [TheMealDB](https://www.themealdb.com) (free, no account).

- **Recipe of the day**, **Surprise me**, **By kind** (beef, chicken, pasta, vegetarian, desserts...), **By country**, search, and **Saved recipes** (Save on a recipe, or the long-press menu).
- A recipe opens its own page: the dish, its ingredients with pictures, the method step by step, and **Watch the video** (most have one on YouTube; it needs the YouTube add-on and offers to install it).
- **Cook along**: one big step at a time, easy to read from across the kitchen. Left / Right (or OK) go through the steps, Down shows the ingredients, and when a step says how long (*simmer for 20 minutes*), Up starts a timer and Kodi tells you when it's up. The screen saver stays away while it's open.
- Its windows are its own, so it looks the same with any skin.

### MediaHub Concerts

**MediaHub Concerts** (`plugin.audio.mediahub.concerts`) plays live shows from the Internet Archive's [Live Music Archive](https://archive.org/details/etree): hundreds of thousands of concerts recorded by fans of bands that allow taping and sharing.

- **Most played shows**, **Bands** (most played first) with each band's shows **Most played**, **Newest first** or **year by year**, **By year** (every band's shows from a year), and search for a band.
- A show lists its **setlist** with the date and venue; **Play the whole show** or start from any song. It remembers the song and the moment you stopped: **Continue listening** (and **Carry on from song 5**), plus **My shows** (the long-press menu).
- **For MediaHub**: the **Concerts: Continue Listening** home row, and its shows in **Continue Anywhere**.
- No account needed.

### MediaHub Relax

**MediaHub Relax** (`plugin.audio.mediahub.relax`) plays calm sounds for as long as you like: **Rain**, **Thunderstorm**, **Ocean waves**, **Crackling fire**, and **White**, **Pink** or **Brown noise**.

- The sounds are made, not recorded, and come with the add-on (seamless one-minute loops), so it works with no internet.
- **Sleep timer**: 15 minutes to 2 hours (or pick one to start with in its settings). Over the last minute the sound fades out, then it stops and the volume goes back to where it was.
- **The relax screen** opens when a sound starts: dark, with soft colours drifting slowly and, for the rain, the waves and the fire, falling rain, rolling waves or a fire's glow with rising sparks. The words fade after a few seconds and it dims further. OK sets the sleep timer, Left / Right changes the sound, Back leaves it playing and Stop stops it. It's its own window, so it works with any skin. (It's a glow rather than a video of a real fire: there's no free fireplace video to use.)

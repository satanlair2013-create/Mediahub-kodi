...
3. Go to **Settings → Add-ons → Install from zip file → mediahub → repository.mediahub-1.0.0.zip**.
4. Go to **Install from repository → MediaHub Repository → Look and feel → Skin → MediaHub → Install**.

Installing through the repository means Kodi updates the skin automatically.
